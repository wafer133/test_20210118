...
class TiebaSpider:
    ...
    def get_content_list(self, html_str):  # 提取数据
        ...
        div_list = html_str.xpath("//div[contains(@class,'i')]")  # 根据div分组
        content_list = []
        for div in div_list:
            item = {}
        ...
        # 提取下一页的url地址
        next_url = self.part_url + html_str.xpath("//a[text()='下一页']/@href")[0] if len(html_str.xpath("//a[text()='下一页']/@href")) > 0 else None
